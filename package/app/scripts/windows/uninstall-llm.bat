...
powershell -NoProfile -ExecutionPolicy Bypass -File "%PACKAGE_DIR%\app\scripts\windows\common-startup.ps1" -Action uninstall -Target llm -PackageDir "%PACKAGE_DIR%"
pause
